...
namespace FilmsDBC.Visual.Buttons
{
    ...
    public class DarkComboBox : UserControl
    {
        //Fields
        private Color backColor = Color.FromArgb(53, 53, 53);
        private Color iconColor = Color.WhiteSmoke;
        private Color listBackColor = Color.FromArgb(53, 53, 53);
        private Color listTextColor = Color.WhiteSmoke;
